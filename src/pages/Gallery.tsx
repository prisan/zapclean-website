...
type Category = "All" | "Car Wash" | "Valet";
...
const items: GalleryItem[] = [
  { id: 1,  src: `${import.meta.env.BASE_URL}images/gallery1.jpg`, category: "Car Wash", label: "Audi foam wash — full exterior" },
  { id: 2,  src: `${import.meta.env.BASE_URL}images/gallery2.jpg`, category: "Valet",    label: "Audi interior deep valet" },
  { id: 3,  src: `${import.meta.env.BASE_URL}images/gallery3.jpg`, category: "Car Wash", label: "Professional equipment ready to go" },
  { id: 4,  src: `${import.meta.env.BASE_URL}images/gallery4.jpg`, category: "Car Wash", label: "Zap Clean on location — Fourways" },
  { id: 5,  src: `${import.meta.env.BASE_URL}images/gallery5.jpg`, category: "Car Wash", label: "Mini Cooper foam bath" },
  { id: 6,  src: `${import.meta.env.BASE_URL}images/gallery6.jpg`, category: "Car Wash", label: "Mini Cooper — full snow foam" },
  { id: 7,  src: `${import.meta.env.BASE_URL}images/gallery7.jpg`, category: "Valet",    label: "Mini Cooper convertible valet" },
  { id: 8,  src: `${import.meta.env.BASE_URL}images/gallery8.jpg`, category: "Valet",    label: "Wheel & tyre detail polish" },
  { id: 9,  src: `${import.meta.env.BASE_URL}images/gallery9.jpg`, category: "Car Wash", label: "BMW wheel scrub & clean" },
];

const categories: Category[] = ["All", "Car Wash", "Valet"];
